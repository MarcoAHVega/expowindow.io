...
? before we write even one line of new code, Let's create a new get branch for this testimonial section:
   ...
   todo> we want to make sure that we currently have a clean working directory:
      ...
      * /or/ if you only need to stage 1 file you can just type the path to that file.
      ^
      git add -A     /or/   git add app/index.html
   ...
   todo> create a new branch  
      ...
      * /or/ if you only want to create the branch
      ^
      git checkout -b testimonials   /or/    git branch testimonials
   ...
   todo> always checkout the branch you want to work on

   -------------------------------------------------------  

   todo> commit changes after working on a branch
   ...
   ---------------------------------------------------------
todo> Once our feature is complete it's no longer a work in progress, We can merge it into our master branch. 
...
---------------------------------------------------------------------------
 ...
 todo> push a master branch to github so we can see a visualization of all the comments.
   ^
...
-------------------------------------------------------------------------
todo> Let's `keep the local copy of our repo clean` by deleting unnecessary branches.
...
todo> We can actually have github perform the merge for us.
